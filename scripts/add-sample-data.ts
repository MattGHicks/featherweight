...
async function addSampleData() {
  ...
  const gearData = [
    // Shelter
    {
      ...
      description: 'Ultralight 2-person DCF tent',
      weight: 595,
      categoryId: categoryMap['Shelter'],
      isWorn: false,
      isConsumable: false,
      retailerUrl: 'https://zpacks.com/products/duplex-tent',
    },
    {
      name: 'Big Agnes Fly Creek HV UL1',
      description: 'Lightweight 1-person tent',
      weight: 907,
      categoryId: categoryMap['Shelter'],
    },
    {
      name: 'Tarp Tent Protrail',
      description: 'Single wall ultralight tent',
      weight: 740,
      categoryId: categoryMap['Shelter'],
    },
    {
      name: 'MSR Hubba Hubba NX',
      description: 'Freestanding 2-person tent',
      weight: 1540,
      categoryId: categoryMap['Shelter'],
    },
    {
      name: 'Zpacks Plexamid',
      description: 'Single person pyramid tent',
      weight: 425,
      categoryId: categoryMap['Shelter'],
    },
    ...
    // Sleep System
    {
      ...
      weight: 680,
      categoryId: categoryMap['Sleep System'],
    },
    {
    ...
    {
      name: 'Sea to Summit Aeros Pillow',
      description: 'Ultralight inflatable pillow',
      weight: 75,
      categoryId: categoryMap['Sleep System'],
    },
    {
      name: 'Zpacks Medium Pillow',
      description: 'Ultralight pillow',
      weight: 40,
      categoryId: categoryMap['Sleep System'],
    },
    ...
    // Backpack
    {
      ...
      description: '60L frameless ultralight pack',
      weight: 735,
      categoryId: categoryMap['Backpack'],
    },
    {
    ...
    },
    {
      ...
      description: 'Lightweight framed pack',
      weight: 1020,
      categoryId: categoryMap['Backpack'],
    },
    {
    ...
    },
    {
      ...
      description: 'Merino wool base layer',
      weight: 140,
      categoryId: categoryMap['Clothing'],
      isWorn: true,
    },
    {
      name: 'Patagonia Strider Pro Shorts',
    ...
    },
    {
      ...
      description: 'Softshell hiking pants',
      weight: 340,
      categoryId: categoryMap['Clothing'],
      isWorn: true,
    },
    ...
    {
      name: 'Jetboil Flash',
      description: 'Integrated stove system',
      weight: 371,
      categoryId: categoryMap['Cooking'],
    },
    {
    ...
    },
    {
      ...
      description: 'Ultralight titanium cookpot',
      weight: 95,
      categoryId: categoryMap['Cooking'],
    },
    {
      name: 'MSR Titan Kettle',
      description: 'Lightweight titanium kettle',
      weight: 118,
      categoryId: categoryMap['Cooking'],
    },
    {
    ...
    },
    {
      ...
      description: 'Isobutane fuel canister',
      weight: 180,
      categoryId: categoryMap['Cooking'],
      isConsumable: true,
    },
    ...
    {
      name: 'Platypus Hoser 2L',
      description: 'Hydration reservoir',
      weight: 115,
      categoryId: categoryMap['Water'],
    },
    {
    ...
    // Navigation
    {
      ...
      weight: 100,
      categoryId: categoryMap['Navigation'],
    },
    {
    ...
    {
      name: 'National Geographic Topo Map',
      description: 'Waterproof topographic map',
      weight: 30,
      categoryId: categoryMap['Navigation'],
    },
    ...
    {
      name: 'Petzl e+LITE',
      description: 'Emergency headlamp',
      weight: 26,
      categoryId: categoryMap['Safety'],
    },
    {
      name: 'Emergency Whistle',
      description: 'Loud safety whistle',
      weight: 8,
      categoryId: categoryMap['Safety'],
    },
    {
      name: 'Emergency Bivvy',
      description: 'Ultralight emergency shelter',
      weight: 85,
      categoryId: categoryMap['Safety'],
    },
    ...
    // Hygiene
    {
      ...
      weight: 15,
      categoryId: categoryMap['Hygiene'],
      isConsumable: true,
    },
    {
      name: 'Toothbrush',
      description: 'Ultralight toothbrush',
      weight: 5,
      categoryId: categoryMap['Hygiene'],
    },
    {
      name: 'Toothpaste Tablets',
      description: 'Toothpaste tablets',
      weight: 20,
      categoryId: categoryMap['Hygiene'],
      isConsumable: true,
    },
    ...
    {
      name: 'Trowel',
      description: 'Lightweight camp trowel',
      weight: 45,
      categoryId: categoryMap['Hygiene'],
    },
    ...
    // First Aid
    {
      name: 'Adventure Medical Ultralight',
      description: 'Ultralight first aid kit',
      weight: 85,
    ...
    {
      name: 'Duct Tape',
      description: 'Multi-purpose tape',
      weight: 15,
      categoryId: categoryMap['First Aid'],
    },
    ...
    // Tools
    {
      name: 'Leatherman Squirt PS4',
      description: 'Ultralight multi-tool',
      weight: 56,
      categoryId: categoryMap['Tools'],
    },
    {
      name: 'Opinel No. 8',
      description: 'Lightweight folding knife',
      weight: 45,
      categoryId: categoryMap['Tools'],
    },
    {
    ...
    {
      name: 'Safety Pins',
      description: 'Assorted safety pins',
      weight: 5,
      quantity: 6,
      categoryId: categoryMap['Tools'],
    },
    ...
    {
      name: 'Peak Refuel Chicken Pesto',
      description: 'Freeze-dried meal',
      weight: 113,
      categoryId: categoryMap['Food'],
      isConsumable: true,
    ...
    // Miscellaneous
    {
      name: 'Lightweight Stuff Sacks',
      description: 'Organization sacks',
      weight: 25,
      quantity: 3,
    ...
    {
      name: 'Carabiners',
      description: 'Aluminum carabiners',
      weight: 12,
      quantity: 4,
      categoryId: categoryMap['Miscellaneous'],
    },
    {
      name: 'Ziploc Bags',
      description: 'Waterproof storage',
      weight: 5,
      quantity: 5,
      categoryId: categoryMap['Miscellaneous'],
    },
  ...
  for (const packListData of packLists) {
    ...
    console.log(
      `Created pack list: ${packListData.name} with ${packListData.items.length} items`
    );
  }
